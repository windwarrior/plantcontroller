...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SensorType.trigger'
        db.delete_column('plantcontroller_sensortype', 'trigger_id')
    ...
    def backwards(self, orm):
        # Adding field 'SensorType.trigger'
        db.add_column('plantcontroller_sensortype', 'trigger',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['plantcontroller.ActuatorTrigger'], null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        'plantcontroller.actuatortrigger': {
            ...
            'trigger': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['plantcontroller.SensorType']"})
        },
